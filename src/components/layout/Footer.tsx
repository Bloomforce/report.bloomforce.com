      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              {/* Restore at launch: <li><a href="/">The Living EHR Talent Benchmark</a></li> */}
              <li><a href="/2025" className="hover:text-primary transition-colors">2025 EHR Workforce Report</a></li>
